...
class ConfigManager:
        ...
        self._config = {
            "analyzers": {
                "security": {
                    ...
                    "rules": {
                        ...
                        "python-security-os-system": {"enabled": True, "severity": "High"},
                        "python-security-pickle-import": {"enabled": True, "severity": "Medium"},
                ...
                "style": {
                    ...
                    "rules": {
                        "python-style-function-naming": {"enabled": True, "severity": "Medium"},
                        "python-style-class-naming": {"enabled": True, "severity": "Medium"},
                        "python-style-variable-naming": {"enabled": True, "severity": "Low"},
                        "python-style-constant-naming": {"enabled": True, "severity": "Low"},
                ...
                "complexity": {
                    ...
                    "max_nested_depth": 4,
                    "rules": {
                        "python-complexity-cyclomatic": {"enabled": True, "severity": "Medium"},
                        "python-complexity-nesting": {"enabled": True, "severity": "Medium"},
                    }
                },
                "documentation": {
                    "enabled": True,
                    ...
                    "rules": {
                        "python-docstring-missing": {"enabled": True, "severity": "Low"},
                ...
                "duplicates": {
                    ...
                    "rules": {
                        ...
                        "code-duplicate-similar": {"enabled": True, "severity": "Medium"},
                    }
                },
                "dead_code": {
                    "enabled": True,
            ...
            "exclusions": {
                "directories": [
                    ...
                    "venv", "env", ".env", "node_modules", "build", "dist",
                    ".vscode", ".idea", "htmlcov", "coverage", ".tox", ".nox"
                ],
                "files": [
    ...
    def validate_config(self) -> list[str]:
        ...
        if output_format not in valid_formats:
            issues.append(f"Invalid output format '{output_format}'. Must be one of: {valid_formats}")
